          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4 h-fit">
              ...
              <div className="group rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all hover:scale-[1.02] bg-gray-100 aspect-square">
                <img
                  src="https://via.placeholder.com/300x300?text=Client+Testimonial"
              ...
              <div className="group rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all hover:scale-[1.02] bg-gray-100 aspect-square">
                <img
                  src="https://via.placeholder.com/300x300?text=Website+Project"
              ...
              <div className="group rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all hover:scale-[1.02] bg-gray-100 aspect-square">
                <img
                  src="https://via.placeholder.com/300x300?text=Revenue+Dashboard"
              ...
              <div className="group rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all hover:scale-[1.02] bg-gray-100 aspect-square">
                <img
                  src="https://via.placeholder.com/300x300?text=Before+After"
